describe("Test the harvest report default values", () => {
    ...
    it("Check the crop dropdown", () => {
        cy.get("[data-cy=option1]").children().should("have.text","ARUGULA")
        cy.get("[data-cy=option5]").children().should("have.text","BEAN-FAVA")
        cy.get("[data-cy=option111]").children().should("have.text","ZUCCHINI")
